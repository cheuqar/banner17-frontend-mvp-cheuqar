...
VITE_SUPABASE_URL=$(doppler secrets get VITE_SUPABASE_URL --config prd --plain)
VITE_SUPABASE_ANON_KEY=$(doppler secrets get VITE_SUPABASE_ANON_KEY --config prd --plain)
VITE_API_BASE_URL=$(doppler secrets get VITE_API_BASE_URL --config prd --plain)
VITE_WS_BASE_URL=$(doppler secrets get VITE_WS_BASE_URL --config prd --plain)
VERSION_MAJOR=$(doppler secrets get VERSION_MAJOR --config prd --plain || echo "0")
VERSION_MINOR=$(doppler secrets get VERSION_MINOR --config prd --plain || echo "0")
...
echo "   URL: https://listez-chatbot.fly.dev/"
